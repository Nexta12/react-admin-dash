      ...
      <div className="userContainer">
        <div className="userShow">
          <div className="userShowTop">
            <img src="../assets/image1.jpg" alt="" className="userShowImg" />
          ...
          <div className="userShowBottom">
            ...
            <div className="userShowInfo">
              ...
              <span className="userShowInfoTitle">annebeck99</span>
            </div>
            <div className="userShowInfo">
            ...
            <div className="userShowInfo">
              ...
              <span className="userShowInfoTitle">annna@gmail.com</span>
            </div>
            <div className="userShowInfo">
            ...
            <form  className="userUpdateForm">
                <div className="userUpdateLeft">
                    ...
                    <div className="userUpdateItem">
                        ...
                        <input type="text" placeholder="annebeck99" className="userUpdateInput" />
                    </div>
                    <div className="userUpdateItem">
                    ...
                    <div className="userUpdateItem">
                        <label>Email</label>
                        <input type="text" placeholder="annna@gmail.com" className="userUpdateInput" />
                    </div>
                    <div className="userUpdateItem">
                        <label>Phone</label>
                ...
                <div className="userUpdateRight">
                    <div className="userUpdateUpload">
                        <img className="userUpdateImg" src="../assets/avarta.jpg" alt="" />
